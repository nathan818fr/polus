...
package com.nathan818.polus.logging.ansi;
...
public abstract class AnsiOutput {
    ...
    private static boolean detectIfAnsiCapable() {
        try {
            ...
            if ((consoleAvailable == null) && (System.console() == null && !Boolean
                    .parseBoolean(System.getProperty("com.nathan818.polus.logging.consoleAvailable", "false")))) {
                return false;
            }
